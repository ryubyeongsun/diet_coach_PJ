...
CREATE TABLE IF NOT EXISTS users (
    ...
    name             VARCHAR(50)  NOT NULL,      -- nickname ??name?�로 변�?
    gender           VARCHAR(10)  NULL,      -- MALE / FEMALE / OTHER
    birth_date       DATE         NULL,      -- age ?�??birth_date ?�용
    ...
    bmr              DOUBLE       NULL,          -- 계산??BMR
    tdee             DOUBLE       NULL,          -- 계산??TDEE
    target_calories  DOUBLE       NULL,          -- 목표 칼로�?TDEE±?�파)
